                ...
                <div class="side-app">
                    <div class="main-container container-fluid">
                        ...
                        <div class="row row-cards card">
                            <form method="POST" action="{{ route('products.store') }}" class="patientForm mt-3">
                                @csrf
                                    ...
                                    <div class="patientDetails row">
                                        ...
                                        <div class="form-outline col-sm-3">
                                            <label class="form-label">Description<span class="" style="color: red">
                                                    *</span></label>
                                            <input type="text" id="description" class="form-control  border-dark"
                                                name="description" />
                                            @error('description')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-outline col-sm-3">
                                            <label class="form-label">Price<span class="" style="color: red">
                                                    *</span></label>
                                            <input type="number" id="price" class="form-control  border-dark"
                                                name="price" />
                                            @error('price')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-outline col-sm-3">
                                            <label class="form-label">Stock Quantity<span class="" style="color: red">
                                                    *</span></label>
                                            <input type="number" id="quantity" class="form-control  border-dark"
                                                name="quantity" />
                                            @error('quantity')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
